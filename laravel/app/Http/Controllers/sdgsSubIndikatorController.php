...
class sdgsSubIndikatorController extends Controller
{
    ...
    public function edit($id_m_subindikator)
    {
        ...
        // $edit_wk=SubIndikator_model::findOrFail($edit_subindikators->waktu_pengambilan);
        ...
        // return view('admin.master_sub_indikator_edit', compact('edit_wk','getId','waktu_pengambilan','indikators','sumberdatas','id_m_subindikator','edit_subindikators','fk_id_indikators','fk_sumberdatas','edit_fk_indikators', 'edit_fk_sumberdatas'));
        // return view('admin.master_sub_indikator_edit', compact('edit_subindikators','fk_id_indikators','fk_sumberdatas','edit_fk_indikators', 'edit_fk_sumberdatas'));
