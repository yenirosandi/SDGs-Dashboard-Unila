...
// }
    ...
    public function changePassword(Request $request)
    {
      ...
      // The passwords matches
        return redirect()->back()->with("error","Password saat ini tidak sama dengan password yang Anda masukkan.");
      }
       
      if(strcmp($request->get('current-password'), $request->get('new-password')) == 0)
      {
      //Current password and new password are same
        return redirect()->back()->with("error","Password baru tidak boleh sama dengan password Anda sebelumnya. Harap masukkan password baru.");
      }
